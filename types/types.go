...
// product -> mushroom / jari
// qty
// rate
// Pre order delivery (exepected delivery)
// Types of musroom / jari -> product name and size
// mode of delivery -> opt
// payement -> AS per discussion b/w b and s

// Product name/type ->
// qty
// rate
// eDOD
// mode of delivery -> self, courier/post, other

// mobile number + aadhar number -> OTP -> verify -> user
